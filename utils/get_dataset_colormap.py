...
_PASCAL = 'pascal'
_APOLLO_ = 'apollo'   #add the dataset name as segmentation_dataset.py
...
_DATASET_MAX_ENTRIES = {
    ...
    _PASCAL: 256,
    _APOLLO_: 36,   #set the num_classes as segmentation_dataset.py
}
...
# add the colormap to dataset that apollo
def create_apollo_label_colormap():
  """Creates a label colormap used in APOLLO segmentation benchmark.
...
def create_label_colormap(dataset=_PASCAL):
  ...
  #add dataset == _APOLLO_
  elif dataset == _APOLLO_:
    return create_apollo_label_colormap()
