...
def main():
    ...
    if 'APOLLO_DATASET' in os.environ:
        ...
        apolloPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..') # the strip location add /../.. in the is ..../apollo/
        print(apolloPath)

    # how to search for all ground truth
    searchFine = os.path.join( apolloPath , "labelimg"   , "*" , "*" , "*" , "*" , "*" , "*Camera_*_bin.png" ) #/deeplab/dataset/cityscapes/gtfine/train/bochum/bochum_00000_000313_gtfine_polygons.json
